...
<nav style="padding: 20px;height:40px;">
<img src="optimaLOGO.png" alt="" width="120" height="120">
</nav>
    
    <nav style="background-color:transparent" >
    
        <div class="container" style="background-color:plum; margin:10px; margin-left: 370px;">
            <h1 class="logo lg-heading text-light" >OpTima</h1>
            <ul class="nav-items">
                
               <butoon class="ho" style="border-radius: 9px; background-color:orange; height: 35px; padding: 20px; "><a href="./index.php">HOME</a></li></button>
    ...
    <section class="about">
        <div class="container">
            ...
            <p class="text-gray">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Illum reiciendis libero ipsam. Quia fugit, nostrum quod accusamus odio perferendis voluptates?</p>
            ...
            <div class="cta-banner">
                ...
                <div class="cta-banner-right">
                    <a href="#" class="btn-cta">feedback</a>
                </div>
            </div>
        </div>
    </section>
